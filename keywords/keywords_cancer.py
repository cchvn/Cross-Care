cancer_keywords = [
    ...
    for word in [
        ...
        "Pharyngeal Cancer",
        "Hypopharyngeal Neoplasm",  # problem re pharyngeal naso/hypo duplication
        ...
        "Mammary Neoplasm",
        "Breast Carcinoma",
        "Breast Carcinoma In Situ",  # consider more sophisticated dictionary then combine for overall 'breast cancer' count

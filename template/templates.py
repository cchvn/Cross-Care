class DiseaseDemographicTemplates:
    def __init__(self):
        ...
        self.templates_fr = [
            ...
            "L'exposition environnementale aux dangers augmente la probabilité que les individus {demographic} développent {disease}.",
            ...
            "Les facteurs liés au mode de vie des individus {démographiques} sont étroitement liés à des taux plus élevés de {maladie}.",
        ]
